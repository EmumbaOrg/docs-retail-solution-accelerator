...
4. Select your resource group.
    ...
    !!! note "Review the list of deployed resources."
        ...
        \*Since we have skipped Azure Container Apps deployment, we shall see `Container Registry`, `Key Vault`, `Container Apps Environment` and `Container Apps` ONLY when we opt to deploy Azure Container Apps later in our guide. In addition to the above resources, you will also see several other resources, like _Managed Identities_, that are supporting resources for those in the table. 
